# eslin + husky 保证前端代码规范

## 安装
::: tip 所需包
1. eslint@5.8.0
2. babel-eslint@10.0.1
3. vue-eslint-parser@5.0.0
4. eslint-plugin-vue@5.1.0
:::

## 配置自定义规则
::: tip 步骤1
- 在根目录下创建基础js校验规则文件eslint_base.js和Vue语法eslint规则文件.eslintrc.js
:::
```js
module.exports = {
...
```
::: tip 步骤2
- .eslintrc.js文件规则继承eslint_base.js文件中的规则
:::
```js
module.exports = {
  extends: [
    './eslint_base.js' // 根目录下基础js校验规则（此处也可使用国外大厂规则）
  ],
...
2. 配置如下规则
:::
![idea-setting.png](./idea-setting.png)
